...
class LoaderMod(loader.Module):
    ...
    strings = {
        ...
        "avail_header": "<b>🌐 🕸️ALFAMod modules from repo</b>",
        ...
        "inline_init_failed": """🚫 <b>This module requires 🕸️ALFAMod inline feature and initialization of InlineManager failed</b>
<i>Please, remove one of your old bots from @BotFather and restart userbot to load this module</i>""",
        "version_incompatible": "🚫 <b>This module requires 🕸️ALFAMod {}+\nPlease, update with </b><code>.update</code>",
    ...
    def __init__(self):
        ...
        self.config = loader.ModuleConfig(
            "MODULES_REPO",
            "https://raw.githubusercontent.com/AmoreForever/FTG-Modules/main/",
